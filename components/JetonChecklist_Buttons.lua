...
function C.StyleButton(btn)
    ...
    if btn.CreateTexture and not btn._JetonCustomHighlight then
        ...
        btn._JetonCustomHighlight = hl
    end

    btn._JetonTabStyled = true
end
...
function C.NewCloseButton(parent, onClick)
    ...
    -- _JetonCloseGlyph intentionally not stored — ApplyThemeColors must not restyle this button.
