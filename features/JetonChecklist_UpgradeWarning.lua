-- JetonChecklist_UpgradeWarning.lua
...
-- button, or via Interface → Jeton's Weekly Checklist.
local addonName = ...
...
local function SetupHooks()
    if ItemUpgradeFrame then
        ...
        disableBtn:SetScript("OnEnter", function()
            ...
            GameTooltip:SetText(L.UPGRADE_WARN_DISABLE_TOOLTIP or "Check Jeton's guide for more information.", 1, 1, 1, 1, true)
            GameTooltip:Show()
        end)
