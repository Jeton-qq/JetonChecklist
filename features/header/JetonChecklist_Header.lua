...
function Addon:CreateHeader(frame)
    ...
    local function EnsureChangeWeekBtn_()
        ...
        btn._JetonArrowTex        = arrowTex
        changeWeekBtn              = btn
        frame._JetonChangeWeekBtn = btn
        return btn
    end
    ...
    local function LayoutHeaderButtons_()
        ...
        if showCW then
            ...
            btn._JetonSelectedLabel = cwWeekLabel
            ...
            btn:SetScript("OnClick", function()
                ...
                if p and p._JetonClosedAt and (GetTime() - p._JetonClosedAt) < 0.20 then p._JetonClosedAt = nil; return end
    ...
    local function RefreshChangeWeekLabel_()
        ...
        if btn._JetonSelectedLabel then btn:SetText(btn._JetonSelectedLabel) end
    end
    ...
    local function CalcChangeWeekBtnWidth_()
        ...
        if not btn._JetonMeasureFS then
            ...
            btn._JetonMeasureFS = scratch
        end
        local scratch      = btn._JetonMeasureFS
